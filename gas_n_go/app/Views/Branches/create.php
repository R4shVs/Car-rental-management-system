        ...
        <div class="flex flex-grow">
            ...
            <div class="flex-grow px-14 mb-12">
                ...
                <div class="w-3/5 mx-auto mt-6">
                    <form action="<?= $home ?>/branches/create.php" method="POST">
                        <div class="flex flex-col bg-white p-10 rounded-lg shadow space-y-16">
                            ...
                            <div class="flex flex-col gap-6">
                                <h2 class="font-bold text-xl text-center
                                <?= (isset($_GET['manager_error'])) ?  'text-red-600' : '' ?>">
                                    Informazioni manager
                                </h2>

                                <?php
                                if (isset($_GET['manager_error'])) {
                                    $msg = $_GET['manager_error'];
                                    include(__DIR__ . '/../Components/error_msg.php');
                                }
                                ?>
                                <?php
                            ...
                            <div class="flex flex-col gap-6">
                                <h2 class="font-bold text-xl text-center
                                <?= (isset($_GET['branch_error'])) ?  'text-red-600' : '' ?>">
                                    Informazioni filiale
                                </h2>

                                <?php
                                if (isset($_GET['branch_error'])) {
                                    $msg = $_GET['branch_error'];
                                    include(__DIR__ . '/../Components/error_msg.php');
                                }
                                ?>
                                <?php
